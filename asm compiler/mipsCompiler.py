...
fileName = str(input("Name of file to compile? (*.text): "))
fileName = "example.txt" #For testing purposes, making runs faster to test.
commands = [] #Master Command array, will hold arrays or commands

#Defines registers $0 - $31 as corrisponding binary values
...
opcode = {'addi':'000010','addu':'000011','addiu':'000100','divu':'000110','div':'000101','multu':'001000','mult':'000111','subu':'001010','sub':'001001','andi':'001100','and':'001011','nandi':'001110','nand':'001101','ori':'010000','or':'001111','nori':'010010','nor':'010001','xori':'010100','xor':'010011','xnori':'010110','xnor':'010101','sll':'010111','srl':'011000','lui':'011001','slti':'011011','sltu':'011100','sltiu':'011101','beq':'011110','bgezal':'100000','bgtz':'100001','blez':'100010','bltzal':'100011','bltz':'100100','bne':'100101','jal':'100111','jr':'101000','j':'100110','lb':'101001','lh':'101010','lw':'101011','sb':'101100','sh':'101101','sw':'101110','mfhi':'101111','mflo':'110000','mthi':'110001','mtlo':'110010','noop':'000000','add':'000001','bgez':'011111','slt':'011010'}

def spliceFileInput(fileInput): #find comma placment within the current line of the file
        ...
        while index < len(fileInput): #Find commas in the supplied string
                ...
                index += 1 #adds on to the place vaule of the desired char, so the next such for the char, starts after the intially found one. (to avoid an inifinte loop of finding the initial desired char)

        tmpArray.append(fileInput[:spacePlace[0]]) #Adds the encoder command the the tmpArray
        fileInput = fileInput[spacePlace[0] + 1:] #Removes the enocder command from the file input, since it has already been spliced into the tmpArray
        ...
        for c in commaPlace: #for the number of commas + the end
                ...
                fileStart = c + 1 #store the begining of the next command's location in the string
...
#first part 'encoder' gets coverted into binary via the 'opcode' dict.
def opcodeConvertion():
        ...
        for c in range(0, numOfSecondaryArrays): #for the number of secondary arrays in commands
                commands[c][0] = opcode[commands[c][0]] #find encoder command (key) in dict, and replace with defintion
        return
                                
#the numbers following get converted into binary via the 'registers' array, number = registers[number]
        #encoders with 'i' at the end will have a hex vaule, hex value will always be the last value in the second dimentional array and start with '0x'
...
def toBinaryConverter():
        ...
        for c in range(0, numOfSecondaryArrays): #for the number of secondary arrays in commands
                ...
                for sc in range(0, numOfConversions): #runs for the number of commands in the second dimension array
                        ...
                        if index == 0: #if a '$' was found and is at the begining of the commands (to avoid conflict with hex vaule commands)
